...
// Mudar Aqui o e-mail -> de preferência colocar email com domínio da hospedagem
$email_envio = "gabriellopes1005@gmail.com"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "bikcraft123"; // Senha do e-mail -> só quem tem acesso é FTP

$site_name = "Bikcraft"; // Nome do Site
$site_url = "www.bikcraft.com"; // URL do Site

// Cada site de hospedagem tem seu método smtp e porta. Consultar
